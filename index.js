...
function getTotalData(data2022, data2023, data2024) {
  ...
  if (!Array.isArray(data2022)) {
    throw new Error("Daten von 2022 sind keine iterierbare Liste");
  }
  if (!Array.isArray(data2023)) {
    throw new Error("Daten von 2023 sind keine iterierbare Liste");
  }
  if (!Array.isArray(data2024)) {
    throw new Error("Daten von 2024 sind keine iterierbare Liste");
  }

  // Sicherstellen, dass die Arrays nicht leer sind
  if (data2022.length === 0) {
    throw new Error("Daten von 2022 sind leer");
  }
  if (data2023.length === 0) {
    throw new Error("Daten von 2023 sind leer");
  }
  if (data2024.length === 0) {
    throw new Error("Daten von 2024 sind leer");
  }
